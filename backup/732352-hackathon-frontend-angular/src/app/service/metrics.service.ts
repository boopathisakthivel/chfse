...
export class MetricsService {
  private associateHeadCountUrl = 'http://localhost:8950/participationMetrics/headCount';
  private uniqueVolunteeringDetailsByLocationUrl = 'http://localhost:8950/participationMetrics/uniqueVolunteeringDetailsByLocation';
  private uniqueVolunteeringDetailsByBUUrl = 'http://localhost:8950/participationMetrics/uniqueVolunteeringDetailsByBU';
